...
public class Producto {
    ...
    public int getEsPreparado() { return esPreparado; }
    public void setEsPreparado(int esPreparado) { this.esPreparado = esPreparado; }
    public int getEsInsumo() { return esInsumo; }
    public void setEsInsumo(int esInsumo) { this.esInsumo = esInsumo; }
