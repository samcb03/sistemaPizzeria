...
public class InventarioController {
    ...
    @FXML
    private TableView<InventarioDetalle> tblInventario;
    @FXML
    private TableColumn<InventarioDetalle, String> colProducto;
    @FXML
    private TableColumn<InventarioDetalle, String> colResultado;
    @FXML
    private TableColumn<InventarioDetalle, Integer> colSistema;
    @FXML
    private TableColumn<InventarioDetalle, Integer> colReal;
    @FXML
    private TableColumn<InventarioDetalle, Integer> colDiferencia;
    ...
    private void cargar() {
        try {
            tblInventario.setItems(FXCollections.observableArrayList(dao.obtenerUltimoReporte()));
        } catch (Exception e) {
    ...
    private void onExportarCSV(ActionEvent e) {
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(archivo))) {
            ...
            Alerta.info("Exito", "Inventario exportado correctamente.");
        } catch (Exception ex) {
